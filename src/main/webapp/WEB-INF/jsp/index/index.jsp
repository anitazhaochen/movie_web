...
<div class="container" style="margin-top: 50px;">
    <c:if test="${u_skl==null}">
        <div class="row">
            <div class="col">
                <%--<marquee  onmouseover='this.stop()' onmouseout='this.start()'><a id="globalLoginBtn_register_input" href="registerInput.html">注册</a>|<a data-toggle="modal" data-target="#myModal" href="javascript:;">登录</a>多高清无码视频</marquee>--%>
            </div>
        </div>
    </c:if>
    <div class="row">
