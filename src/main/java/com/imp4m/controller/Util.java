...
import com.imp4m.util.JSONUtil;
import com.imp4m.util.SendMail;
...
public class Util implements ServletContextAware {
    ...
    public @ResponseBody
    String upload(String childPath, HttpServletRequest httpServletRequest) throws IOException {
        /**
         * 文件上传处理
         */
    ...
    public @ResponseBody String deletePic(String picsPath) {
